...
#df = pd.read_csv("/Users/husazwerg/code/gitlab.fhnw.ch/gruppen_arbeit/npr_fs25/MC1/data_mc1/cleantech_media_dataset_v3_2024-10-28.csv")
df_train_cleaned = pd.read_parquet('../data_mc1/data_processed/df_train_cleaned.parquet')
df_train_cleaned.head()

df_200_cleaned = df_train_cleaned.head(20)
